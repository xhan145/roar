...
def test_settings_smoke():
    ...
    assert "navs=10" in out and "priv=1" in out and "privnav=1" in out
    ...
    assert "diag=1" in out and "diagnav=1" in out and "safe=1" in out
    assert "appearance=3" in out and "format=1" in out
